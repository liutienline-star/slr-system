...
def generate_pdf_report(stu_id, subject, exam_range, tags, obs, diag):
    ...
    pdf.ln(5)
    pdf.multi_cell(0, 8, txt=f"【AI 補強指導建議】\n{diag}")
